// Service worker for Kokoro TTS extension.
// Model inference cannot run in an MV3 service worker (no Web Audio, no GPU context),
// so we delegate to an offscreen document which has full DOM/WebGPU access.
